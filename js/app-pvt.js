var flightType
  ...
  function back(){
    document.getElementById("back-pvt").style.display ="";
 ...
 document.getElementById("submit").addEventListener("click", function(event){
  ...
  document.getElementById("back-pvt").style.display ="none";
  ...
  document.getElementById("print").style.display ="";
      ...
      document.getElementById('span').innerHTML=perTime0;
        ...
        console.log(pax)
         ...
         budget=(paxNbr*pax) +  landingCalc0 + parkingcalc0 *(parkingCalc-1) + lightingCalc0*lightingCalc + approachcalc0
         //alert(budget)
